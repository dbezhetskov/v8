...
MemoryChunkMetadata* MemoryChunk::Metadata() {
  ...
  DCHECK_LT(metadata_index_, MemoryChunkConstants::kMetadataPointerTableSizeMask);
  ...
  MemoryChunkMetadata* metadata =
      metadata_pointer_table[metadata_index_ & MemoryChunkConstants::kMetadataPointerTableSizeMask];
#else
  MemoryChunkMetadata* metadata =
      metadata_pointer_table_[metadata_index_ & MemoryChunkConstants::kMetadataPointerTableSizeMask];
